...
type QueryGetIBCForwardResponse struct {
	IbcForward IBCForward `protobuf:"bytes,1,opt,name=ibcForward,proto3" json:"ibcForward"`
}
...
func (m *QueryGetIBCForwardResponse) GetIbcForward() IBCForward {
	if m != nil {
		return m.IbcForward
	}
	return IBCForward{}
...
type QueryAllIBCForwardsResponse struct {
	IbcForwards []IBCForward        `protobuf:"bytes,1,rep,name=ibcForwards,proto3" json:"ibcForwards"`
	Pagination  *query.PageResponse `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
}
...
func (m *QueryAllIBCForwardsResponse) GetIbcForwards() []IBCForward {
	if m != nil {
...
var fileDescriptor_248fc3ff0338b430 = []byte{
	...
	,
}
...
func (m *QueryAllIBCForwardsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.IbcForwards = append(m.IbcForwards, IBCForward{})
